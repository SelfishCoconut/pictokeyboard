...
fun SettingsScreen(
    ...
    SettingsScreenContent(
        ...
        onSentenceUnvalidated = viewModel::setSentenceUnvalidated,
...
private fun SentenceAndAssistanceGroups(
    ...
    onSentenceUnvalidated: (Boolean) -> Unit,
    ...
    SettingsGroup(stringResource(R.string.settings_group_sentence)) {
        SentenceHelpSection(
            ...
            unvalidated = settings.sentenceUnvalidated,
            onUnvalidated = onSentenceUnvalidated,
    ...
    Scaffold(topBar = { SettingsTopBar(onBack) }) { padding ->
        Column(
            ...
            SentenceAndAssistanceGroups(
                ...
                onSentenceUnvalidated = onSentenceUnvalidated,
